      ...
      <section className="hero min-h-screen bg-gray-100 px-6 py-4 rounded">
        <div className="my-2 mx-auto">
          ...
          <div className="hero-content grid md:grid-cols-2 sm:grid-cols-1 h-auto mt-2">
            <div className="card bg-emerald-100 shadow-xl text-center lg:text-left h-full justify-center items-center md:w-3/4 ml-20">
              ...
              <div className="card-body">
                  <div className="card-actions justify-center">
                    <button className="btn btn-accent p-0 md:px-4">
                      ...
                      <p>Email Us: <span className="ml-2 lowercase underline"> info@jobconnect.com</span></p>
                    </button>
                    <button className="btn btn-accent p-0 md:px-4">

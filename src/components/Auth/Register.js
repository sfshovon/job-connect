  ...
  return (
    <section className="h-screen mt-16 bg-gray-100">
      <div className="flex justify-center">
        ...
        <div className="bg-emerald-100 w-4/5 md:w-1/4 flex-col rounded-2xl shadow-lg p-5 items-center my-10">
          ...
          <div className="mt-3 text-xs flex justify-between items-center text-[#002D74] py-1">
            ...
            <button onClick={() => navigate('/signin')}  className="btn btn-sm border rounded-xl hover:scale-110 duration-300">Sign In</button>
          </div>
        </div>
        <ToastContainer/>
      </div>
